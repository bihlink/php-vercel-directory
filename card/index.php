    ...
    <div class="container shadow pt-3 mb-3" style="max-width:800px;">
        <?php if ($json[$card]["approved"] == "false") {
            ...
            if ($json[$card]["type"] == "misskey") {
                ...
                echo '<iframe allowfullscreen sandbox="allow-top-navigation allow-scripts" width="100%" height="800" src="https://maplefeed.bihlink.com/apiv2/feed?userurl=https://'.$json[$card]["instanceurl"].'/users/'.$json[$card]["username"].'&theme=modern-light&size=100&header=true&replies='.$json[$card]["replies.'boosts='.$json[$card]["boosts"].'"></iframe>';
